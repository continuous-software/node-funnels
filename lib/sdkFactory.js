...
/**
 * create resource factory based on resource links specifications
 *
 * @param linksSpecifications Object - a link specification which follows the JSON schema specifications
 * @param options Object - options to resolve api endpoint
 * @returns {Function} - a Factory function which automatically create a sdk based on passed specifications
 */
module.exports = function (linksSpecifications, options) {
  const optionsOrDefault = Object.assign({},{protocol: 'http'}, options || {});
  const prototype = {};
